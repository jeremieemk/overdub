...
function Index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    helloSection.current.addEventListener("visibilitychange", function () {
      console.log(helloSection.current.visibilityState);
    }); // clean up

    return function () {
      return helloSection.current.removeEventListener("visibilitychange", function () {
        if (helloSection.current.visibilityState === "visible") {
          console.log("ik");
        }
      });
    };
  }, []);
  console.log(helloSection.current && helloSection.current.visibilityState);
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.9700c472d2c1579aa115.hot-update.js.map