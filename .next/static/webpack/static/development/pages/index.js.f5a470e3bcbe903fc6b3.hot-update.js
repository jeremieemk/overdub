...
function Index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    console.log(helloSection.current);
    helloSection.current.addEventListener("visibilitychange", function () {
      helloSection.current.visibilityState === "visible" && console.log(helloSection.current.visibilityState);
    });
    console.log(helloSection.current.visibilityState);
  }, [helloSection.current]);
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.f5a470e3bcbe903fc6b3.hot-update.js.map