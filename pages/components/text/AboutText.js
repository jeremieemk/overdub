const AboutText = () => (
  <div className="about-text">
    ...
    <p className="">
      ...
      them myself. During those years I was busy having a career as a DJ and
    ...
    <p>
      ...
      was a revelation. I then felt more confident to take on more ambitious
      ...
      the following years. I did a React project last year for an internet radio
      that involved interactions with a map. I also built an architect portfolio
      using jquery and Vapid. During summer 2019 I also helped the Reveel team
      building their music metadata app on React Native.
    </p>
    <p>
